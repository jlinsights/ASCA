...
describe('WebSocket Manager', () => {
  ...
  describe('Authentication', () => {
    it('should authenticate client with valid token', async () => {
      ...
      const authMessage = socket.sentMessages.find(msg => msg.type === WSMessageType.AUTHENTICATED)
  ...
  describe('Event Broadcasting', () => {
    ...
    it('should broadcast to wildcard subscribers', async () => {
      ...
      const updatedEvent = socket.sentMessages.find(
        msg => msg.type === WSMessageType.EVENT && msg.payload.type === EventType.MEMBER_UPDATED
      )
