    ...
    const sampleArtists = [
      {
        ...
        bioEn:
          'An artist who creates new artistic language through modern interpretation of traditional calligraphy.',
        birthYear: 1975,
        nationality: '대한민국',
      ...
      },
      {
        ...
        bioEn:
          'Serving as a bridge for Korea-China-Japan calligraphy exchange and contributing to the development of East Asian calligraphy culture.',
        birthYear: 1968,
        nationality: '대한민국',
    ...
    const sampleArtworks = [
      {
        ...
        descriptionEn:
          'A work that reinterprets the spirit of traditional calligraphy with modern sensibility.',
      ...
      },
      {
        ...
        descriptionEn:
          'A work exploring new possibilities of calligraphy through innovative approaches.',
        category: 'calligraphy' as const,
        style: '초서',
        medium: '비단, 먹',
      ...
      },
      {
        ...
        descriptionEn:
          'A work expressing the commonalities and differences of Korea-China-Japan calligraphy culture.',
        category: 'calligraphy' as const,
        style: '해서',
        medium: '한지, 먹',
    ...
    const sampleExhibitions = [
      {
        ...
        descriptionEn:
          'A special exhibition presenting new horizons of calligraphy where tradition meets modernity.',
        ...
        curatorNotes:
          '이번 전시는 동양 서예의 정통성과 현대적 창신이 어떻게 조화를 이룰 수 있는지를 보여줍니다.',
        isFeatured: true,
      },
      {
        id: 'exhibition-002',
        ...
        titleJp: '東アジア書道交流展',
        description:
          '한국, 중국, 일본 서예가들의 작품을 통해 동아시아 서예 문화의 다양성을 조명합니다.',
        descriptionKo:
          '한국, 중국, 일본 서예가들의 작품을 통해 동아시아 서예 문화의 다양성을 조명합니다.',
        descriptionEn:
          'Illuminating the diversity of East Asian calligraphy culture through works by Korean, Chinese, and Japanese calligraphers.',
        type: 'group' as const,
        ...
        curatorNotes:
          '동아시아 삼국의 서예 전통이 어떻게 서로 영향을 주고받았는지 살펴볼 수 있는 기회입니다.',
        isFeatured: true,
      },
    ]
    ...
    const sampleNews = [
      {
        ...
        content:
          '2024년 동양서예협회 정기총회가 3월 20일 오후 2시에 개최됩니다. 모든 회원님들의 참석을 부탁드립니다.',
        contentKo:
          '2024년 동양서예협회 정기총회가 3월 20일 오후 2시에 개최됩니다. 모든 회원님들의 참석을 부탁드립니다.',
        contentEn:
          'The 2024 Oriental Calligraphy Association Annual General Meeting will be held on March 20th at 2 PM. We request the attendance of all members.',
      ...
      },
      {
        ...
        content:
          '동양서예협회에서 신진 작가 발굴을 위한 특별 프로그램을 운영합니다. 많은 관심과 참여 부탁드립니다.',
        contentKo:
          '동양서예협회에서 신진 작가 발굴을 위한 특별 프로그램을 운영합니다. 많은 관심과 참여 부탁드립니다.',
        contentEn:
          'The Oriental Calligraphy Association is running a special program to discover emerging artists. We ask for your interest and participation.',
    ...
    const sampleEvents = [
      {
        ...
        description:
          '서예 입문자를 위한 기초 워크숍입니다. 붓잡는 법부터 기본 획까지 차근차근 배워보세요.',
        descriptionKo:
          '서예 입문자를 위한 기초 워크숍입니다. 붓잡는 법부터 기본 획까지 차근차근 배워보세요.',
        descriptionEn:
          'A basic workshop for calligraphy beginners. Learn step by step from holding the brush to basic strokes.',
      ...
      },
      {
        ...
        descriptionEn:
          'A lecture series to appreciate Oriental calligraphy masterpieces and explore their meanings in depth.',
    ...
    const sampleGalleries = [
      {
        ...
        descriptionEn:
          'A space for permanent display of representative works of the Oriental Calligraphy Association.',
...
// 새로운 시드 모듈 import
import { seedMembershipTiers } from './seed/seed-membership-tiers'
import { seedPartners } from './seed/seed-partners'
import { seedContestResults } from './seed/seed-contest-results'

export { seedMembershipTiers, seedPartners, seedContestResults }
