...
export const typeResolvers = {
  ...
  MembershipTier: {
    ...
    benefits: (parent: any) => {
      ...
      return typeof parent.benefits === 'string'
        ? JSON.parse(parent.benefits)
        : parent.benefits;
    },
  },
  ...
  Artist: {
    ...
    awards: (parent: any) => {
      ...
      return typeof parent.awards === 'string'
        ? JSON.parse(parent.awards)
        : parent.awards;
    },
  ...
  Artwork: {
    ...
    imageUrls: (parent: any) => {
      ...
      return typeof parent.imageUrls === 'string'
        ? JSON.parse(parent.imageUrls)
        : parent.imageUrls;
    },
  ...
  Event: {
    ...
    images: (parent: any) => {
      ...
      return typeof parent.images === 'string'
    ...
    materials: (parent: any) => {
      ...
      return typeof parent.materials === 'string'
        ? JSON.parse(parent.materials)
        : parent.materials;
    },
