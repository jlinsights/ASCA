...
describe('Mutation Resolvers', () => {
  ...
  describe('createMember', () => {
    ...
    it('should throw error when not authenticated', async () => {
      ...
      await expectAuthError(() =>
        mutationResolvers.createMember({}, { input }, context)
      );
    });
  ...
  describe('approveMember', () => {
    it('should approve member and set status to active (admin only)', async () => {
      ...
      const result = await mutationResolvers.approveMember(
        {},
        { id: 'member-1' },
        context
      );
  ...
  describe('rejectMember', () => {
    ...
    it('should throw error when not admin', async () => {
      ...
      await expectAuthzError(() =>
        mutationResolvers.rejectMember({}, { id: 'member-1' }, context)
      );
    });
  });
  ...
  describe('submitMembershipApplication', () => {
    it('should submit membership application', async () => {
      ...
      const result = await mutationResolvers.submitMembershipApplication(
        {},
        { input },
        context
      );
  ...
  describe('reviewMembershipApplication', () => {
    it('should review and approve application (admin only)', async () => {
      ...
      context.db.query.membershipApplications.findFirst = jest
        .fn()
  ...
  describe('createArtist', () => {
    ...
    it('should throw error when not authenticated', async () => {
      ...
      await expectAuthError(() =>
        mutationResolvers.createArtist({}, { input: {} }, context)
      );
    });
  });
  ...
  describe('createArtwork', () => {
    it('should create artwork', async () => {
      ...
      expect(context.loaders.artworksByArtistLoader.clear).toHaveBeenCalledWith(
        'artist-1'
      );
    });
    ...
    it('should throw error when not authenticated', async () => {
      ...
      await expectAuthError(() =>
        mutationResolvers.createArtwork({}, { input: {} }, context)
      );
    });
  });
  ...
  describe('updateArtwork', () => {
    it('should update artwork when user owns the artist', async () => {
      ...
      const result = await mutationResolvers.updateArtwork(
        {},
        { id: 'artwork-1', input },
        context
      );
  ...
  describe('deleteArtwork', () => {
    it('should delete artwork when user owns the artist', async () => {
      ...
      const result = await mutationResolvers.deleteArtwork(
        {},
        { id: 'artwork-1' },
        context
      );
  ...
  describe('registerForEvent', () => {
    it('should register user for event', async () => {
      ...
      const result = await mutationResolvers.registerForEvent(
        {},
        { eventId: 'event-1' },
        context
      );
    ...
    it('should throw error when already registered', async () => {
      ...
      const context = createAuthContext({ id: 'user-1' });
      context.db.query.eventParticipants.findFirst = jest
        .fn()
  ...
  describe('cancelEventRegistration', () => {
    it('should cancel event registration', async () => {
      ...
      const context = createAuthContext({ id: 'user-1' });
      (context.loaders.eventParticipantLoader.load as jest.Mock).mockResolvedValue(
        participant
      );
      (context.loaders.eventLoader.load as jest.Mock).mockResolvedValue(event);
      ...
      expect(result).toBe(true);
      expect(context.loaders.eventParticipantLoader.clear).toHaveBeenCalledWith(
        'participant-1'
      );
      expect(context.loaders.eventLoader.clear).toHaveBeenCalledWith('event-1');
    });
    ...
    it('should throw error when user does not own the registration', async () => {
      ...
      await expectAuthzError(() =>
        mutationResolvers.cancelEventRegistration(
          {},
          { participantId: 'participant-1' },
          context
        )
