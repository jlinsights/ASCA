...
describe('Query Resolvers', () => {
  ...
  describe('members', () => {
    ...
    it('should filter members by status', async () => {
      ...
      const result = await queryResolvers.members(
        {},
  ...
  describe('searchMembers', () => {
    it('should search members by name', async () => {
      ...
      const result = await queryResolvers.searchMembers(
        {},
        { query: 'John', limit: 10 },
        context
      );
  ...
  describe('membershipTiers', () => {
    it('should return all active tiers', async () => {
      ...
      const result = await queryResolvers.membershipTiers(
        {},
        { isActive: true },
        context
      );
  ...
  describe('artists', () => {
    ...
    it('should filter by isActive', async () => {
      ...
      const result = await queryResolvers.artists(
        {},
        { first: 20, isActive: true },
        context
      );
  ...
  describe('searchArtists', () => {
    it('should search artists by name', async () => {
      ...
      const result = await queryResolvers.searchArtists(
        {},
        { query: 'Pablo', limit: 10 },
        context
      );
  ...
  describe('exhibitions', () => {
    ...
    it('should filter by type', async () => {
      ...
      const result = await queryResolvers.exhibitions(
        {},
        { first: 20, type: 'solo' },
        context
      );
  ...
  describe('events', () => {
    ...
    it('should filter by type', async () => {
      ...
      const result = await queryResolvers.events(
        {},
        { first: 20, type: 'workshop' },
        context
      );
  ...
  describe('galleries', () => {
    ...
    it('should filter by type', async () => {
      ...
      const result = await queryResolvers.galleries(
        {},
        { type: 'permanent' },
        context
      );
  ...
  describe('newsList', () => {
    ...
    it('should filter by category', async () => {
      ...
      const result = await queryResolvers.newsList(
        {},
        { category: 'news' },
        context
      );
  ...
  describe('featuredNews', () => {
    it('should return pinned and published news', async () => {
      const featuredNews = [
        { id: 'news-1', isPinned: true, status: 'published' },
      ];
      const context = createMockContext();
