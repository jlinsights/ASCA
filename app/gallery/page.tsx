    ...
    <div className='space-y-8'>
      <div className='masonry-grid'>
        {Array.from({ length: 12 }, (_, i) => (
          <div
            key={i}
            className='aspect-square bg-gray-200 rounded-2xl animate-pulse loading-shimmer'
          />
        ))}
      </div>
    </div>
  ...
  return (
    <div className='min-h-screen bg-transparent'>
      ...
      <section className='py-20 bg-muted/30 border-t border-border'>
        <div className='max-w-7xl mx-auto px-6 md:px-12'>
          <div className='text-center mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-foreground'>추가 서비스</h2>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6'>
            <Card className='group hover-scale smooth-transition border-border'>
              <CardContent className='p-6'>
                ...
                >
                  <Link href='/exhibitions'>자세히 보기</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className='group hover-scale smooth-transition border-border'>
              <CardContent className='p-6'>
                ...
                <Button
                  ...
                  className='p-0 h-auto text-primary hover:text-primary'
                >
                  <Link href='/contests'>자세히 보기</Link>
                </Button>
              </CardContent>
            </Card>
      ...
      <section className='py-20 bg-background border-t border-border'>
        <div className='max-w-7xl mx-auto px-6 md:px-12'>
          <div className='text-center mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-foreground'>문의 및 연락처</h2>
            <p className='text-lg text-muted-foreground'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-muted-foreground'>info@orientalcalligraphy.org</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-muted-foreground'>209-82-11380</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: '동양서예협회 갤러리',
            description:
              '동양서예협회의 전시회, 심사위원회, 휘호대회, 시상식 등 다양한 협회 활동을 담은 종합 갤러리. 전통 서예의 정법을 계승하고 현대적 창신을 통해 동양서예의 새로운 미래를 열어가는 협회의 발자취를 기록합니다.',
            ...
            image: data.items.slice(0, 8).map(item => ({
              ...
              url:
                typeof window !== 'undefined' ? `${window.location.origin}${item.src}` : item.src,
              thumbnailUrl:
