...
const mockGetSSEManager = getSSEManager as jest.MockedFunction<
  typeof getSSEManager
>;
const mockCreateSSEResponse = createSSEResponse as jest.MockedFunction<
  typeof createSSEResponse
>;
...
describe('SSE API Route', () => {
  ...
  describe('Stream Creation', () => {
    ...
    it('should create SSE stream with wildcard event types', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/realtime/sse?eventTypes=member:*'
      );
  ...
  describe('Authentication', () => {
    ...
    it('should accept token from query parameter', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/realtime/sse?token=test-token'
      );
  ...
  describe('Error Handling', () => {
    ...
    it('should handle empty event types parameter', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/realtime/sse?eventTypes='
      );
  ...
  describe('Manager Integration', () => {
    it('should use singleton SSE manager', async () => {
      const request1 = new NextRequest(
        'http://localhost:3000/api/realtime/sse'
      );
