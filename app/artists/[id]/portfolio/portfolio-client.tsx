      ...
      <div className='min-h-screen bg-transparent flex flex-col'>
        <div className='flex-1 flex items-center justify-center'>
          <div className='text-center'>
            ...
            <Button onClick={() => router.push('/artists')}>작가 목록으로 돌아가기</Button>
          </div>
        </div>
        <LayoutFooter />
      </div>
          ...
          <div className='container mx-auto px-4'>
            <div className='max-w-5xl mx-auto'>
              <div className='flex flex-col md:flex-row gap-8 items-center md:items-start'>
                ...
                <div className='flex-1 text-center md:text-left'>
                    ...
                    <div className='flex flex-wrap gap-2 justify-center md:justify-start mb-4'>
                      {profile.specialization.map(spec => (
                        <Badge
                          key={spec}
                          variant='secondary'
                          className='bg-celadon-green/20 text-celadon-green'
                        >
                          {spec}
                        </Badge>
                      ))}
                  ...
                  {config?.showContact !== false && (
                    <p className='text-foreground leading-relaxed mb-6 max-w-2xl'>{profile.bio}</p>
                  )}
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-12'>
                ...
                <div className='bg-card border border-celadon-green/20 rounded-lg p-4 text-center'>
                  <div className='text-3xl font-bold text-celadon-green'>
          ...
          <div className='container mx-auto px-4'>
            <div className='max-w-7xl mx-auto'>
              <div className='text-center mb-12'>
                <h2 className='text-3xl font-serif font-bold text-foreground mb-4'>대표 작품</h2>
                <p className='text-muted-foreground'>작가의 선별된 작품들을 감상해보세요</p>
              </div>
              ...
              {featuredArtworks.length === 0 ? (
                ...
                >
                  {featuredArtworks.map(artwork => (
                    <ArtworkCard key={artwork.id} artwork={artwork} showActions={false} />
                  ))}
                </div>
              )}
          ...
          <section className='py-16 bg-rice-paper/50 dark:bg-stone-gray/10'>
            <div className='container mx-auto px-4'>
              <div className='max-w-2xl mx-auto text-center'>
                <h2 className='text-3xl font-serif font-bold text-foreground mb-4'>문의하기</h2>
                ...
                <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                  ...
                  {profile.phone && (
                    <Button asChild variant='outline' size='lg'>
                      <a href={`tel:${profile.phone}`}>전화 문의</a>
                    </Button>
                  )}
                </div>
              </div>
