              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {profile.specializations
                        ? JSON.parse(profile.specializations).map((style: any) => (
                  ...
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {profile.interests
                        ? JSON.parse(profile.interests).map((interest: any) => (
                  ...
                  <div>
                    ...
                    <div className='flex gap-2'>
                      {profile.languages
                        ? JSON.parse(profile.languages).map((lang: any) => (
                        ...
                        (edu: any, index: number) => (
                          <div key={index} className='p-3 border border-border rounded-lg'>
                            ...
                            <div className='text-xs text-muted-foreground mt-1'>
                              전공:{' '}
                              {edu.focus
                                ?.map((f: any) => styleNames[f as CalligraphyStyle] || f)
                                .join(', ')}
                            </div>
                          </div>
                        )
