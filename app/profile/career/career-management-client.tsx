...
export function CareerManagementClient() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      const { data: careerData, error } = await fetchCareerEntries(clerkUser.id)
      ...
      // Fetch summary
      const { data: summaryData } = await getCareerSummary(clerkUser.id)
      if (summaryData) {
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='mb-8'>
            ...
            <div className='flex items-center justify-between'>
              <div>
                <h1 className='text-4xl font-serif font-bold text-foreground mb-2'>이력 관리</h1>
                <p className='text-muted-foreground'>전시, 수상, 학력 등 작가 이력을 관리하세요</p>
              </div>
              <Button
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-8'>
              ...
              <Card>
                <CardContent className='pt-6'>
                  <div className='flex items-center justify-between'>
                    <div>
                      <p className='text-2xl font-bold text-scholar-red'>
                        {summary.education || 0}
                      </p>
          ...
          <Tabs defaultValue='all' className='mb-8'>
            <TabsList className='grid w-full grid-cols-4 lg:grid-cols-8'>
              <TabsTrigger value='all' onClick={() => setFilters({ ...filters, types: undefined })}>
                전체
              </TabsTrigger>
