...
const partners = ['삼성금융네트웍스', '예술의전당', '대한검정회', '서울특별시', '문화체육관광부']
        ...
        <div className='container mx-auto px-4 py-24 md:py-32'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed'>
              엑셀과 수작업에서 벗어나세요. 마케팅 자동화, 데이터 파이프라인, AI 챗봇으로 협회
              운영의 새로운 기준을 만듭니다.
            </p>
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            {services.map(service => (
              ...
              >
                ...
                <p className='text-base font-medium text-foreground/80 mb-3'>{service.headline}</p>
            ...
            {painPoints.map(item => (
              ...
              >
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <span className='text-sm font-medium text-muted-foreground'>{item.icp}</span>
                </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center'>
            {[
              ...
              <div key={stat.label}>
                <p className='text-3xl md:text-4xl font-bold text-rice-paper mb-1'>{stat.value}</p>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-muted-foreground'>대한민국 대표 문화예술 기관들이 신뢰합니다</p>
          </div>
