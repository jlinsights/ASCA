      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
              ...
              <div>
                 ...
                 <div className="space-y-2 text-sm">
                   <div className="flex justify-between border-b pb-1">
                     ...
                     <span>{formData.category ? ARTWORK_CATEGORY_LABELS[formData.category].ko : '-'}</span>
                   </div>
                   <div className="flex justify-between border-b pb-1">
                   ...
                   <div className="flex justify-between border-b pb-1">
                     ...
                     <span>
                       {formData.height} x {formData.width} {formData.depth ? `x ${formData.depth}` : ''} {formData.unit}
                     </span>
                   </div>
                   <div className="flex justify-between border-b pb-1">
                   ...
                   {formData.isForSale && (
                     <div className="flex justify-between border-b pb-1 font-semibold">
                       ...
                       <span>
                         {formData.price ? new Intl.NumberFormat().format(Number(formData.price)) : 0} {formData.currency}
                       </span>
                     </div>
                   )}
                 </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit} className="bg-celadon-green hover:bg-celadon-green/90 text-white">
              등록하기
            </Button>
          </DialogFooter>
        </DialogContent>
