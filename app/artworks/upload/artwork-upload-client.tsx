              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setFormData({ ...formData, yearCreated: parseInt(e.target.value) })
                    }
                    min='1900'
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setFormData({ ...formData, status: value as ArtworkStatus })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className='space-y-2 text-sm'>
                  ...
                  {formData.isForSale && (
                    <div className='flex justify-between border-b pb-1 font-semibold'>
                      ...
                      <span>
                        {formData.price
                          ? new Intl.NumberFormat().format(Number(formData.price))
                          : 0}{' '}
                        {formData.currency}
                      </span>
                    </div>
