...
const categoryInfo = {
  calligraphy: {
    ...
    descriptionEn:
      'Discover Korean, Chinese, and Japanese calligraphy works spanning tradition and modernity',
  },
  painting: {
    title: '회화',
    titleEn: 'Painting',
    ...
    descriptionEn:
      'Appreciate diverse paintings from traditional landscapes to contemporary oriental art',
  },
  sculpture: {
    title: '조각',
    titleEn: 'Sculpture',
...
const sampleArtworks: Artwork[] = [
  {
    ...
    images: ['/images/artworks/hwangjeguk-chode.avif'],
    isAvailable: true,
    isFeatured: true,
    tags: ['봄', '산수', '전통'],
    views: 156,
  ...
  },
  {
    ...
    images: ['/images/artworks/choinanju-chode.avif'],
    isAvailable: true,
    isFeatured: false,
    tags: ['서예', '현대', '먹향'],
    views: 89,
  ...
  },
  {
    ...
    images: ['/images/artworks/limhyeongi-chode.avif'],
    isAvailable: false,
    isFeatured: true,
    tags: ['조각', '청동', '현대'],
    views: 234,
  ...
  },
  {
    ...
    images: ['/images/artworks/yeomjeongmo-chode.avif'],
    isAvailable: true,
    isFeatured: false,
    tags: ['혼합매체', '실험', '전통'],
    views: 123,
      ...
      <section className='border-b border-border bg-card'>
        <div className='container mx-auto px-4 py-4 md:py-6'>
          ...
          <div className='flex items-center justify-between md:hidden mb-4'>
            ...
            <div className='text-sm text-muted-foreground'>{categoryArtworks.length}개</div>
          </div>
          ...
          {/* Filter Controls */}
          <div
            className={`${showFilters ? 'block' : 'hidden md:flex'} flex-col md:flex-row md:items-center md:justify-between gap-4`}
          >
