      ...
      <section className='py-12 md:py-20 bg-gradient-to-b from-muted/30 to-background'>
        <div className='container mx-auto px-4 text-center'>
          <div className='flex items-center justify-center gap-3 mb-6'>
            ...
            <h1 className='text-3xl md:text-5xl font-bold tracking-tight'>개인정보처리방침</h1>
          </div>
          ...
          <Card className='border-l-4 border-l-blue-600'>
            <CardContent className='p-6 md:p-8'>
              ...
              <p className='text-sm md:text-base text-muted-foreground'>
                사단법인 동양서예협회(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사
              ...
              <div className='space-y-6 text-sm md:text-base text-muted-foreground'>
                <div>
                  ...
                  <div className='bg-muted/50 p-4 rounded-lg space-y-2'>
                    <p>
                      <strong>회원가입시:</strong> 필수항목 - 아이디, 비밀번호, 이름, 생년월일,
                      성별, 전화번호, 휴대전화번호, 이메일, 주소
                    </p>
                    <p>
                      <strong>선택항목:</strong> 직업, 취미, 기타 등
                    </p>
                  </div>
                </div>
                <div>
                  <h3 className='font-semibold text-foreground mb-2'>
                    ② 서비스 이용과정이나 사업처리 과정에서 아래와 같은 정보들이 생성되어 수집될 수
                    있습니다.
                  </h3>
            ...
            <CardContent className='p-6 md:p-8'>
              ...
              <div className='space-y-4 text-sm md:text-base text-muted-foreground'>
                <p>
                  ...
                  수집시에 동의 받은 개인정보 보유, 이용 기간 내에서 개인정보를 처리, 보유합니다.
                </p>
                <p>② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</p>
                <div className='bg-muted/50 p-4 rounded-lg space-y-2'>
                  <p>
                    <strong>홈페이지 회원가입 및 관리:</strong> 사업자/단체 홈페이지 탈퇴시까지
                  </p>
                  <p>
                    <strong>재화 또는 서비스 제공:</strong> 재화·서비스 공급완료 및 요금결제·정산
                    완료시까지
                  </p>
                </div>
              </div>
              ...
              <div className='space-y-4 text-sm md:text-base text-muted-foreground'>
                ...
                <div className='bg-orange-50 dark:bg-orange-950/30 p-4 rounded-lg border border-orange-200 dark:border-orange-800'>
                  ...
                  <div className='space-y-2 text-sm'>
                    <p>
                      1. <strong>Edge:</strong> 웹브라우저 우측 상단의 설정 메뉴 &gt; 쿠키 및 사이트
                      권한 &gt; 쿠키 및 사이트 데이터 관리 및 삭제
                    </p>
                    <p>
                      2. <strong>Chrome:</strong> 웹브라우저 우측 상단의 설정 메뉴 &gt; 개인정보 및
                      보안 &gt; 쿠키 및 기타 사이트 데이터
                    </p>
                    <p>
                      3. <strong>Whale:</strong> 웹브라우저 우측 상단의 설정 메뉴 &gt; 개인정보 보호
                      &gt; 쿠키 및 기타 사이트 데이터
                    </p>
                  </div>
                </div>
              ...
              <div className='space-y-6 text-sm md:text-base text-muted-foreground'>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='bg-scholar-red/5 p-4 rounded-lg border border-scholar-red/20'>
                    ...
                    <div className='space-y-2 text-sm'>
                      <p>
                        <strong>성명:</strong> 임재홍
                      </p>
                      <p>
                        <strong>직책:</strong> 이사장
                      </p>
                      <p>
                        <strong>전화번호:</strong> 02-928-1117
                      </p>
                      <p>
                        <strong>이메일:</strong> ceo@orientalcalligraphy.org
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='bg-muted/50 p-4 rounded-lg'>
                    ...
                    <div className='space-y-2 text-sm'>
                      <p>
                        <strong>담당부서:</strong> 사무국장
                      </p>
                      <p>
                        <strong>전화번호:</strong> 02-928-1117
                      </p>
                      <p>
                        <strong>이메일:</strong> info@orientalcalligraphy.org
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p>
                  ② 회사는 개인정보의 보호를 위해 개인정보보호 전담부서를 운영하고 있으며,
                  개인정보처리방침의 이행사항 및 담당자의 준수여부를 확인하여 문제가 발견될 경우
                  즉시 해결하고 바로 잡을 수 있도록 최선을 다하고 있습니다.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className='space-y-4 text-sm md:text-base text-muted-foreground'>
                ...
                <div className='bg-purple-50 dark:bg-purple-950/30 p-4 rounded-lg border border-purple-200 dark:border-purple-800'>
                  ...
                  <div className='space-y-2 text-sm'>
                    ...
                    <p>
                      • <strong>중앙행정심판위원회:</strong> (국번없이) 110 (www.simpan.go.kr)
                    </p>
                  </div>
                </div>
          ...
          <Card className='bg-muted/30'>
            <CardContent className='p-6 md:p-8'>
              ...
              <div className='space-y-2 text-sm md:text-base text-muted-foreground'>
                <p>
                  <strong>제1조</strong> 본 방침은 2024.01.01.부터 시행됩니다.
                </p>
                <p>
                  <strong>제2조</strong> 개정 전 개인정보처리방침은 공지사항을 통하여 확인할 수
                  있습니다.
                </p>
              </div>
            </CardContent>
          ...
          <Card className='bg-gradient-to-r from-blue-600/5 to-blue-600/10 border-blue-600/20'>
            <CardContent className='p-6 md:p-8 text-center'>
              ...
              <p className='text-sm md:text-base text-muted-foreground mb-4'>
                개인정보처리방침에 대해 궁금한 사항이나 개인정보 관련 문의가 있으시면 언제든지
                연락해 주세요.
              </p>
