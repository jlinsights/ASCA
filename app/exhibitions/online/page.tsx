...
const onlineExhibitions = [
  {
    ...
    viewers: 25000,
    artworks: 200,
    image: '/images/exhibitions/exhibition-20th-ig.avif',
    isInteractive: true,
    hasCatalog: true,
  },
  {
    ...
    viewers: 8500,
    artworks: 50,
    image: '/images/exhibitions/calligraphy-hall.avif',
    isInteractive: true,
    hasCatalog: false,
  },
]
      ...
      <section className='bg-transparent py-16'>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <h1 className='text-4xl md:text-5xl font-normal mb-6'>온라인 전시관</h1>
            <p className='text-lg text-muted-foreground'>디지털 기술로 만나는 새로운 서예 경험</p>
          </div>
        </div>
      </section>
