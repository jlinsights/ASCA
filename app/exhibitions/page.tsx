            ...
            <>
              ...
              <div className='space-y-6'>
                ...
                <div className='relative aspect-[16/9] bg-muted rounded-lg overflow-hidden'>
                  <Image
                    src={
                      selectedExhibition.featured_image_url ||
                      '/images/exhibitions/poster-20th.avif'
                    }
                  ...
                  <div className='absolute bottom-4 left-4 right-4'>
                    <div className='flex items-end justify-between'>
                      <div>
                        ...
                        <p className='text-white/90'>{selectedExhibition.subtitle}</p>
                      </div>

                      <div className='flex gap-2'>
                        <Badge
                          className={
                            statusColors[selectedExhibition.status as keyof typeof statusColors]
                          }
                        >
                ...
                <Tabs defaultValue='info' className='w-full'>
                          ...
                          <div className='flex items-start gap-3'>
                            ...
                            <div>
                              ...
                              <div className='text-muted-foreground'>
                                {formatDate(selectedExhibition.start_date)} -{' '}
                              ...
                              <div className='text-muted-foreground'>
                                {selectedExhibition.is_free
                                  ...
                                  : selectedExhibition.ticket_price
                                    ? formatPrice(
                                        selectedExhibition.ticket_price,
                                        selectedExhibition.currency || 'KRW'
                                      )
                                    : t('contactForPrice')}
                              </div>
                            </div>
                  ...
                  <TabsContent value='artists'>
                    {selectedExhibition.participating_artists &&
                    selectedExhibition.participating_artists.length > 0 ? (
                  ...
                  <TabsContent value='artworks'>
                    {selectedExhibition.featured_artworks &&
                    selectedExhibition.featured_artworks.length > 0 ? (
                      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                  ...
                  <TabsContent value='gallery'>
                    {selectedExhibition.gallery_images &&
                    selectedExhibition.gallery_images.length > 0 ? (
                ...
                <div className='flex gap-2 pt-4 border-t'>
                  <Button className='flex-1' onClick={() => toggleLike(selectedExhibition.id)}>
                    <Heart
                      className={`h-4 w-4 mr-2 ${likedExhibitions.has(selectedExhibition.id) ? 'fill-current' : ''}`}
                    />
                    {t('like')}
                  </Button>
