...
const currentExhibitions = [
  {
    ...
    subtitle: '전통과 현대의 만남',
    description:
      '동양서예협회 회원들의 한 해 성과를 집약한 정기전시입니다. 전통 서예의 정수와 현대적 해석이 어우러진 작품들을 만나보실 수 있습니다.',
    ...
    artworks: 120,
    image: '/images/exhibitions/poster-20th.avif',
    gallery: [
      '/images/exhibitions/sac-poster.avif',
      '/images/exhibitions/exhibition-20th-ig.avif',
      '/images/exhibitions/pamphlet-20th-cover.avif',
    ],
    highlights: [
      '한글서예 특별 섹션',
      '젊은 작가들의 현대적 해석',
  ...
  },
  {
    ...
    description:
      '한글의 과학성과 예술성을 서예를 통해 조명하는 특별전입니다. 궁체부터 현대 캘리그라피까지 한글 서예의 다양한 면모를 선보입니다.',
    ...
    artworks: 80,
    image: '/images/exhibitions/sac-poster.avif',
    gallery: [
      '/images/exhibitions/chode-catalog-1.avif',
      '/images/exhibitions/calligraphy-hall.avif',
    ],
    highlights: [
      '궁체 서예의 정수',
      '현대 한글 캘리그라피',
      ...
      <section className='bg-gradient-to-b from-muted/50 to-background py-16'>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <h1 className='text-4xl md:text-5xl font-normal mb-6'>현재 진행 중인 전시</h1>
          ...
          {currentExhibitions.map((exhibition, index) => (
            <Card key={exhibition.id} className='overflow-hidden'>
              ...
              >
                {/* Image */}
                <div
                  className={`relative aspect-[9/16] ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}
                >
                  <Image
                  ...
                  <div className='absolute top-4 left-4 flex gap-2'>
                    ...
                    <Badge
                      className={`${getExhibitionTypeStyle(exhibition.type).color} text-white`}
                    >
                ...
                >
                  <div className='space-y-6'>
                    ...
                    <div className='flex gap-3'>
                      <Button asChild>
                        <Link href={`/exhibitions/${exhibition.id}`}>전시 상세보기</Link>
                      </Button>
                      <Button variant='outline'>관람 예약</Button>
                    </div>
                  </div>
                </CardContent>
              </div>
