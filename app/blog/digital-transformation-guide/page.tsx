...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '서예협회, 갤러리, 문화센터를 위한 디지털 전환 실전 가이드',
    type: 'article',
  },
}
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto'>
            ...
            <p className='text-lg md:text-xl text-muted-foreground leading-relaxed mb-8'>
              서예협회, 갤러리, 문화센터가 엑셀과 수작업에서 벗어나 회원관리, 전시홍보, 문의응대를
              자동화하는 실전 전략.
            </p>
          ...
          <div className='max-w-3xl mx-auto'>
            ...
            <section id='current-state' className='mb-16'>
              ...
              <p className='text-foreground/80 leading-relaxed mb-6'>
                ...
                운영됩니다. 회원 명부는 엑셀 파일 수십 개에 흩어져 있고, 전시 홍보는 블로그에
                수동으로 포스팅하며, 문의 전화는 담당자가 직접 받습니다.
              </p>
              ...
              <p className='text-foreground/80 leading-relaxed'>
                이런 방식은 <strong>담당자 1~2명이 모든 것을 처리하는</strong> 소규모 단체에서 특히
                치명적입니다. 사람이 바뀌면 데이터가 사라지고, 노하우가 단절됩니다. 디지털 전환은
                선택이 아니라 <strong>생존의 문제</strong>입니다.
              </p>
            </section>
              ...
              <div className='space-y-6'>
                ...
                <div className='rounded-xl border border-border/50 bg-card p-6'>
                  <div className='flex items-center gap-3 mb-4'>
                    ...
                    <h3 className='text-xl font-serif font-bold text-foreground'>마케팅 자동화</h3>
                  </div>
                  <p className='text-foreground/80 leading-relaxed mb-4'>
                    전시가 열리면 자동으로 회원에게 알림이 갑니다. 수강 기간이 끝나기 전에 재등록
                    안내가 발송됩니다. 행사가 끝나면 만족도 조사 링크가 전달됩니다.
                  </p>
                  <div className='flex items-center gap-2 text-sm text-celadon-green'>
                    <Lightbulb className='h-4 w-4' />
                    <span>
                      효과: 홍보 업무 시간 <strong>70% 절감</strong>, 행사 참여율{' '}
                      <strong>2배</strong> 향상
                    </span>
                  </div>
                </div>
                ...
                <div className='rounded-xl border border-border/50 bg-card p-6'>
                  ...
                  <p className='text-foreground/80 leading-relaxed mb-4'>
                    엑셀 파일 30개를 하나의 대시보드로 통합합니다. 작가의 활동 이력이 자동으로
                    쌓이고, 전시 방문객 추이를 실시간으로 확인할 수 있습니다.
                  </p>
                  <div className='flex items-center gap-2 text-sm text-scholar-red'>
                    <Lightbulb className='h-4 w-4' />
                    <span>
                      효과: 보고서 작성 시간 <strong>80% 절감</strong>, 데이터 기반 의사결정
                    </span>
                  </div>
                </div>
                ...
                <div className='rounded-xl border border-border/50 bg-card p-6'>
                  <div className='flex items-center gap-3 mb-4'>
                    ...
                    <h3 className='text-xl font-serif font-bold text-foreground'>AI 챗봇</h3>
                  </div>
                  <p className='text-foreground/80 leading-relaxed mb-4'>
                    &ldquo;전시 언제까지 하나요?&rdquo; &ldquo;수강료가 얼마인가요?&rdquo; 이런 반복
                    문의의 80%를 AI가 자동으로 답변합니다. 담당자는 정말 중요한 상담에만 집중할 수
                    있습니다.
                  </p>
                  <div className='flex items-center gap-2 text-sm text-temple-gold'>
                    <Lightbulb className='h-4 w-4' />
                    <span>
                      효과: 문의 응대 시간 <strong>80% 절감</strong>, 24시간 무중단 응대
                    </span>
                  </div>
                </div>
              </div>
            ...
            <section id='step-by-step' className='mb-16'>
              ...
              <div className='space-y-6'>
                ...
                <div className='flex gap-4'>
                  ...
                  <div className='pb-8'>
                    <h3 className='text-lg font-bold text-foreground mb-2'>1~3개월: 데이터 통합</h3>
                    <p className='text-foreground/80 leading-relaxed mb-3'>
                      가장 먼저 흩어진 데이터를 한곳에 모읍니다. 엑셀 회원 명부를 통합 DB로
                      마이그레이션하고, 작가/작품/전시 정보를 체계적으로 정리합니다.
                    </p>
                ...
                <div className='flex gap-4'>
                  ...
                  <div className='pb-8'>
                    ...
                    <p className='text-foreground/80 leading-relaxed mb-3'>
                      데이터가 정리되면 자동 커뮤니케이션을 설정합니다. 전시 알림, 수강 안내, 생일
                      축하 메시지 등을 자동으로 발송합니다.
                    </p>
                    <ul className='space-y-1 text-sm text-foreground/70'>
                      <li className='flex items-center gap-2'>
                        <CheckCircle2 className='h-4 w-4 text-celadon-green' />
                ...
                <div className='flex gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-foreground/80 leading-relaxed mb-3'>
                      데이터와 자동화가 안정되면 AI 챗봇을 추가합니다. 축적된 FAQ 데이터로 챗봇을
                      학습시켜 정확도를 높입니다.
                    </p>
                    <ul className='space-y-1 text-sm text-foreground/70'>
                      <li className='flex items-center gap-2'>
            ...
            <section id='getting-started' className='mb-16'>
              ...
              <p className='text-foreground/80 leading-relaxed mb-6'>
                디지털 전환의 첫걸음은 <strong>현재 상태를 진단</strong>하는 것입니다. 아래 질문에
                3개 이상 해당된다면, 지금이 시작할 때입니다.
              </p>
              ...
              <p className='text-foreground/80 leading-relaxed'>
                동양서예협회는 직접 디지털 전환을 경험하며 쌓은 노하우를 바탕으로, 비슷한 고민을
                가진 문화예술 단체에 <strong>맞춤형 솔루션</strong>을 제공합니다.
              </p>
            </section>
