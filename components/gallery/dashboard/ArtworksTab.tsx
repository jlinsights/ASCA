  ...
  return (
    <div className='space-y-2'>
      {filteredArtworks.map((artwork: any) => {
        const primaryImage =
          artwork.images.find((img: any) => img.type === 'primary') || artwork.images[0]
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isSelected
                ? 'bg-celadon-green/10 border-celadon-green/30'
                : 'hover:bg-silk-cream/50 border-transparent'
            )}
        ...
        return (
          ...
          >
            ...
            <CardContent className='p-4'>
              ...
              <p className='text-sm text-ink-black/70 mb-2 line-clamp-1'>{artwork.title.english}</p>
          ...
          <div className='flex flex-col lg:flex-row gap-4'>
            ...
            <div className='flex gap-2'>
              <select
                ...
                onChange={e =>
                  setFilters((prev: any) => ({ ...prev, status: e.target.value as any }))
                }
              ...
              <select
                ...
                onChange={e =>
                  setFilters((prev: any) => ({ ...prev, visibility: e.target.value as any }))
                }
                className='p-2 border border-celadon-green/20 rounded-md bg-rice-paper text-sm'
              >
