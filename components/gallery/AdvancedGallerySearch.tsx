...
} from './search/GalleryFilterSections'
  ...
  const renderActiveFilters = () => {
        ...
        if (artist) {
          activeFilters.push({
            ...
            remove: () =>
              updateFilter(
                'artist_ids',
                filters.artist_ids?.filter(id => id !== artistId)
              ),
          })
        }
      })
    ...
    return (
      <div className='flex flex-wrap gap-2 mb-4'>
        ...
        <Button size='sm' variant='outline' onClick={clearFilters} className='h-6 px-2 text-xs'>
          Clear All
        </Button>
      </div>
    )
              ...
              >
                <div>
                  ...
                  <p className='text-xs text-ink-black/60'>
                    {savedSearch.result_count} results •{' '}
                    {savedSearch.created_date.toLocaleDateString()}
                  </p>
                </div>
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className='text-center'>
        <h1 className='font-calligraphy text-2xl font-bold text-ink-black mb-2'>Gallery Search</h1>
        ...
        <div className='fixed inset-0 bg-ink-black/50 flex items-center justify-center z-50'>
          <Card className='w-96 max-w-full mx-4'>
            ...
            <CardContent className='space-y-4'>
              <div>
                <label className='block text-sm font-medium text-ink-black mb-2'>Search Name</label>
                <Input
                  type='text'
