...
export const CulturalHighlight = ({
  ...
  const variantStyles = {
    scholar:
      'bg-gradient-to-r from-scholar-red/30 to-scholar-red/50 dark:from-scholar-red/20 dark:to-scholar-red/40',
    bamboo:
      'bg-gradient-to-r from-bamboo-green/30 to-bamboo-green/50 dark:from-bamboo-green/20 dark:to-bamboo-green/40',
    temple:
      'bg-gradient-to-r from-temple-gold/30 to-temple-gold/50 dark:from-temple-gold/20 dark:to-temple-gold/40',
