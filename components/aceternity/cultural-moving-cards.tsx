...
export const CulturalMovingCards = ({
  ...
  const getCategoryColor = (category?: string) => {
    switch (category) {
      case 'calligraphy':
        return 'border-ink-black dark:border-rice-paper'
      case 'painting':
        return 'border-scholar-red dark:border-scholar-red'
      case 'poetry':
        return 'border-bamboo-green dark:border-bamboo-green'
      case 'philosophy':
        return 'border-temple-gold dark:border-temple-gold'
      default:
        return 'border-stone-gray dark:border-stone-gray'
    }
  }
            ...
            <blockquote>
              ...
              <div className='relative z-20 mt-6 flex flex-col gap-2'>
                <div className='flex items-center justify-between'>
                  ...
                  {item.location && (
                    <span className='text-xs text-stone-gray font-mono'>{item.location}</span>
                  )}
                </div>
