...
export function ImageUploader({
  ...
  const handleFiles = useCallback(
    ...
    [images, maxFiles, onFilesSelected, validateFile]
  )
    ...
    <div className='space-y-4'>
      ...
      >
        ...
        >
          ...
          <h3 className='text-lg font-serif font-semibold text-foreground mb-2'>이미지 업로드</h3>
          ...
          <div className='flex flex-wrap justify-center gap-2 text-xs text-muted-foreground'>
            <span className='px-2 py-1 bg-stone-gray/10 rounded'>JPG, PNG, WEBP</span>
            <span className='px-2 py-1 bg-stone-gray/10 rounded'>최대 {maxFileSize}MB</span>
            <span className='px-2 py-1 bg-stone-gray/10 rounded'>최대 {maxFiles}개</span>
          </div>
        </label>
      </div>
