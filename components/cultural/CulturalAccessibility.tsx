...
const CulturalAccessibility: React.FC<CulturalAccessibilityProps> = ({
  ...
  const [activePanel, setActivePanel] = useState<'accessibility' | 'language' | 'cultural'>(
    'accessibility'
  )
            ...
            <div className='flex items-center gap-2'>
              <Button
                ...
                onClick={() =>
                  updateAccessibilitySetting(
                    'fontSize',
                    Math.max(12, accessibilitySettings.fontSize - 2)
                  )
                }
              ...
              <Button
                ...
                onClick={() =>
                  updateAccessibilitySetting(
                    'fontSize',
                    Math.min(24, accessibilitySettings.fontSize + 2)
                  )
                }
                className='h-8 w-8 p-0'
              >
            ...
            <div className='flex items-center gap-2'>
              <Button
                ...
                onClick={() =>
                  updateAccessibilitySetting(
                    'lineHeight',
                    Math.max(1.2, accessibilitySettings.lineHeight - 0.1)
                  )
                }
                className='h-8 w-8 p-0'
              >
              ...
              <Button
                ...
                onClick={() =>
                  updateAccessibilitySetting(
                    'lineHeight',
                    Math.min(2.0, accessibilitySettings.lineHeight + 0.1)
                  )
                }
                className='h-8 w-8 p-0'
              >
        ...
        <div className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Button
              ...
              onClick={() =>
                updateAccessibilitySetting('motionReduced', !accessibilitySettings.motionReduced)
              }
              className='h-8'
            >
          ...
          {[
            ...
            <div key={key} className='flex items-center justify-between'>
              ...
              <Button
                size='sm'
                variant={
                  accessibilitySettings[key as keyof AccessibilitySettings] ? 'default' : 'outline'
                }
                onClick={() =>
                  updateAccessibilitySetting(
        ...
        <div className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Button
              ...
              onClick={() =>
                updateLanguageSetting('pronunciation', !languageSettings.pronunciation)
              }
              className='h-8'
            >
        ...
        <div className='space-y-3'>
            ...
            <Button
              ...
              onClick={() =>
                updateCulturalSetting(
                  ...
                  !culturalSettings.culturalExplanations
                )
              }
              className='h-8'
            >
          ...
          <div className='flex items-center justify-between'>
            ...
            <Button
              ...
              onClick={() =>
                updateCulturalSetting('historicalContext', !culturalSettings.historicalContext)
              }
              className='h-8'
            >
