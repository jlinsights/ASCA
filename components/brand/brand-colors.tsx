  ...
  return (
    <section className='brand-section' id='color-palette'>
      ...
      <p className='mb-8 text-base'>
        Galleria의 컬러 팔레트는 동아시아 예술의 전통적 재료와 자연에서 영감을 받았습니다. 깊은
        먹색부터 종이의 따스함까지, 각 색상은 예술의 역사와 정신을 담고 있습니다.
      </p>
      ...
      <div className='color-palette'>
        <div className='color-swatch bg-ink-black text-rice-paper'>
          ...
          <div className='color-info'>
            먹의 깊이와 전통의 권위를 상징하는 주요 색상, 라이트 모드에서 텍스트, 다크 모드에서
            배경색으로 사용
          </div>
        </div>
        <div className='color-swatch bg-rice-paper text-ink-black border border-gray-200'>
          ...
          #f5f5f0
          <div className='color-info'>
            한지의 따스한 질감과 순수함을 담은 색상, 라이트 모드에서 배경색, 다크 모드에서 텍스트
            색상으로 사용
          </div>
        </div>
        ...
        <div className='usage-grid'>
          <div className='usage-item'>
            ...
            <ul className='usage-list'>
              <li>
                <strong>Traditional Ink Black:</strong> 라이트 모드에서 텍스트, 다크 모드에서
                배경색으로 활용
              </li>
              <li>
                <strong>Rice Paper White:</strong> 라이트 모드에서 배경색, 다크 모드에서 텍스트
                색상으로 사용
              </li>
              <li>
                <strong>Celadon Green:</strong> 버튼, 하이라이트, 인터랙티브 요소에 적용하여 사용자
                행동 유도
              </li>
              <li>
