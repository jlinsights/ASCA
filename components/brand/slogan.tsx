        ...
        <div className='usage-grid'>
          <div className='usage-item'>
            ...
            <ul className='usage-list'>
              ...
              <li>
                <strong>광고 카피:</strong> 주요 광고의 헤드라인이나 클로징 메시지로 사용
              </li>
              <li>
                <strong>프로모션 이벤트:</strong> 시즌별 마케팅 캠페인의 핵심 메시지로 활용
              </li>
              <li>
                <strong>브랜드 스토리텔링:</strong> 콘텐츠 마케팅의 일관된 주제로 발전
              </li>
            </ul>
          </div>
          <div className='usage-item'>
            ...
            <ul className='usage-list'>
              ...
              <li>
                <strong>전시 카탈로그:</strong> 표지나 서문에 슬로건 포함
              </li>
              <li>
                <strong>공간 디자인:</strong> 전시장, 휴게 공간의 벽면 그래픽으로 적용
              </li>
              <li>
                <strong>기념품 및 굿즈:</strong> 티셔츠, 토트백, 문구류 등의 디자인 포인트
              </li>
            </ul>
          </div>
          <div className='usage-item'>
            ...
            <ul className='usage-list'>
              ...
              <li>
                <strong>중국어:</strong> "超越想象的艺术体验"
              </li>
              <li>
                <strong>일본어:</strong> "想像を超える芸術体験"
              </li>
              <li>
                <strong>지역별 변형:</strong> 문화적 맥락에 맞게 의미를 유지하며 지역화
              </li>
            </ul>
          </div>
        </div>
