...
export function LazyComponentLoader({
  ...
  if (errorBoundary) {
    return <LazyErrorBoundary>{suspenseWrapper}</LazyErrorBoundary>
  }
...
export function useLazyComponent<T = any>(config: LazyLoadConfig) {
  ...
  return function LazyWrapper(props: T) {
    return (
      <LazyComponentLoader fallback={config.fallback} errorBoundary={true}>
        <LazyComponent {...props} />
      </LazyComponentLoader>
    )
  }
...
export { DefaultFallback, DefaultErrorComponent, LazyErrorBoundary }
