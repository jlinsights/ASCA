...
1. **rev β 7연속 검증**: Match avg 98.6% (95/100/100/95/100/100/100), unplanned ejection 0
2. **route.test.ts 0 fail 달성** (5 cycle chain: dataloader → auth-cleanup → mutation-auth → error-policy)
3. **Test assertion ≠ source 수정** — production 동작 자체는 정합, test 가정만 stale
