...
이 가이드는 ASCA 프로젝트에서 Context7 MCP (Model Context Protocol) 서버를
설정하는 방법을 설명합니다.

## 🎯 개요

Context7 MCP 서버는 AI 컨텍스트 관리 및 문서화를 위한 도구입니다. 다음과 같은
기능을 제공합니다:
...
Supabase MCP와 Context7 MCP를 함께 사용하면 강력한 시너지 효과를 얻을 수
있습니다:
...
**Note**: Context7 MCP는 stdio 모드로 실행되므로 직접적인 명령행 상호작용은
제한적입니다. 주로 Claude Desktop을 통해 사용하는 것이 권장됩니다.
